 ...
 */
public class CancelTaskMain1 {
    private static final Logger LOG = LoggerFactory.getLogger(CancelTaskMain1.class);
    public static void main(String[] args) {
         ...
         * 任务无法停止
         */
        Future future = taskExecutor.submit(new CancelTask1());
