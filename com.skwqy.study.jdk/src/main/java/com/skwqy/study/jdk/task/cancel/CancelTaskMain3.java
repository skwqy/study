 ...
 */
public class CancelTaskMain3 {
    private static final Logger LOG = LoggerFactory.getLogger(CancelTaskMain3.class);
    public static void main(String[] args) {
         ...
         * 任务无法停止
         */
        Future future = taskExecutor.submit(new CancelTask3());
